...
<?php foreach($detail as $dt) : ?>
  <div class="card">
    ...
    <div class="row">
      <div class="col-md-5">
        <img width="300" src="<?php echo base_url(). 'assets/upload/'.$dt->gambar ?>">
      </div>
          ...
          <table class="table">
           ...
           <tr>
             ...
             <td><?php if($dt->status == "0"){
              ...
              echo "<span class='badge badge-primary'>Tidak Tersedia</span>";
             } ?>
             </td>
           </tr>
            </table>
            ...
            <a class="btn btn-sm btn-primary ml-3" href="<?php echo base_url('admin/data_mobil/update_mobil/'. $dt->id_mobil) ?>">Update</a>
